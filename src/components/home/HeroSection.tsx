...
const collage = [
  ...
  },
  {
    ...
    className: "bottom-8 left-0 h-[42%] w-[52%]",
  },
  {
    src: "https://images.unsplash.com/photo-1557672172-298e0d96a2b2?w=600&h=700&fit=crop",
    alt: "Topographic line illustration",
    className: "top-[18%] left-[8%] h-[38%] w-[44%]",
  },
  {
    src: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=600&h=700&fit=crop",
    alt: "Futuristic space scene",
    className: "bottom-0 right-[6%] h-[44%] w-[56%]",
  },
];
    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-indigo-50/80 via-white to-white pb-16 pt-10 sm:pb-20 sm:pt-14">
      <Container>
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-10">
          <div>
            <p className="inline-flex items-center gap-2 rounded-full bg-white px-3 py-1 text-xs font-semibold uppercase tracking-wide text-indigo-700 ring-1 ring-indigo-100 shadow-sm">
              <Sparkles className="h-3.5 w-3.5" aria-hidden />
              AI artwork · community powered
            </p>
            ...
            <dl className="mt-10 grid gap-4 sm:grid-cols-3">
              ...
              <div className="rounded-2xl bg-white/80 p-4 ring-1 ring-slate-200/80 shadow-sm backdrop-blur">
                ...
                <dd className="mt-1 text-xs leading-relaxed text-slate-600">
                  You keep and use it. [Placeholder legal copy]
                </dd>
              </div>
              <div className="rounded-2xl bg-white/80 p-4 ring-1 ring-slate-200/80 shadow-sm backdrop-blur">
                <dt className="flex items-center gap-2 text-sm font-semibold text-slate-900">
